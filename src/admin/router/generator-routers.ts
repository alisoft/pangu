...
const rootRouter: MenuDataItem = {
  ...
  component: () => import("@/admin/layouts/index.vue"),
  children: [] as MenuDataItem[],
};

const defineRouteComponents: Record<string, any> = {
  BasicLayout: () => import("@/admin/layouts/index.vue"),
  RouteView: () => import("@/admin/layouts/route-view.vue"),
  PageView: () => import("@/admin/layouts/route-view.vue"),
};
