    ...
    <div class="view-left">
      <a-form layout="vertical">
        ...
        <a-form-item label="Province or city">
          <city-select
            v-model:province="modelRef.province"
            v-model:city="modelRef.city"
          />
        </a-form-item>
...
import CitySelect from "@/admin/components/city-select/index.vue";
import InputPhone from "@/admin/components/input-phone/index.vue";
